...
2. Watch live API outputs:
   ...
   - `validateUTF8`
3. Scroll to **Safe DOM API** to see a rendered widget built using typed DOM primitives.
4. Scroll to **Unsafe DOM sink hardening** to see blocked sink attempts (`innerHTML`, etc.).
5. Scroll to **URL encoding** to review allowed vs blocked URL schemes.
